...
const (
	...
	DiscoveryServiceName = "fleetd.v1.DiscoveryService"
)
...
const (
	...
	// GetDeviceInfo RPC.
	DiscoveryServiceGetDeviceInfoProcedure = "/fleetd.v1.DiscoveryService/GetDeviceInfo"
	// DiscoveryServiceConfigureDeviceProcedure is the fully-qualified name of the DiscoveryService's
	// ConfigureDevice RPC.
	DiscoveryServiceConfigureDeviceProcedure = "/fleetd.v1.DiscoveryService/ConfigureDevice"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	discoveryServiceServiceDescriptor               = v1.File_fleetd_v1_discovery_proto.Services().ByName("DiscoveryService")
...
// DiscoveryServiceClient is a client for the fleetd.v1.DiscoveryService service.
...
// NewDiscoveryServiceClient constructs a client for the fleetd.v1.DiscoveryService service. By
...
// GetDeviceInfo calls fleetd.v1.DiscoveryService.GetDeviceInfo.
...
// ConfigureDevice calls fleetd.v1.DiscoveryService.ConfigureDevice.
...
// DiscoveryServiceHandler is an implementation of the fleetd.v1.DiscoveryService service.
...
func NewDiscoveryServiceHandler(svc DiscoveryServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/fleetd.v1.DiscoveryService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedDiscoveryServiceHandler) GetDeviceInfo(context.Context, *connect.Request[v1.GetDeviceInfoRequest]) (*connect.Response[v1.GetDeviceInfoResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("fleetd.v1.DiscoveryService.GetDeviceInfo is not implemented"))
}
...
func (UnimplementedDiscoveryServiceHandler) ConfigureDevice(context.Context, *connect.Request[v1.ConfigureDeviceRequest]) (*connect.Response[v1.ConfigureDeviceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("fleetd.v1.DiscoveryService.ConfigureDevice is not implemented"))
}
