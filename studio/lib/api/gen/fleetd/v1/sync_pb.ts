...
export const file_fleetd_v1_sync: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_timestamp]);
 ...
 *
 * @generated from message fleetd.v1.StreamSyncRequest
 */
export type StreamSyncRequest = Message<"fleetd.v1.StreamSyncRequest"> & {
  /**
   * @generated from oneof fleetd.v1.StreamSyncRequest.data
   */
  data: {
    /**
...
/**
 * Describes the message fleetd.v1.StreamSyncRequest.
 * Use `create(StreamSyncRequestSchema)` to create a new message.
 */
export const StreamSyncRequestSchema: GenMessage<StreamSyncRequest> = /*@__PURE__*/
  messageDesc(file_fleetd_v1_sync, 13);

/**
 * Sync command from server
 *
 * @generated from message fleetd.v1.StreamSyncResponse
 */
export type StreamSyncResponse = Message<"fleetd.v1.StreamSyncResponse"> & {
  /**
   * @generated from oneof fleetd.v1.StreamSyncResponse.command
   */
  command: {
    /**
...
/**
 * Describes the message fleetd.v1.StreamSyncResponse.
 * Use `create(StreamSyncResponseSchema)` to create a new message.
 */
export const StreamSyncResponseSchema: GenMessage<StreamSyncResponse> = /*@__PURE__*/
