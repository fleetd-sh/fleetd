              ...
              <div className="space-y-4">
                ...
                <div className="rounded-lg border p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Button size="sm" variant="outline">Schedule Update</Button>
                  </div>
                </div>
              </div>
            </CardContent>
